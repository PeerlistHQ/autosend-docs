...
- Add your domain or subdomain (we recommend using a subdomain like [mail.yourdomain.com](http://mail.yourdomain.com))
- Configure DNS records (DKIM, SPF, DMARC)
- Verify domain ownership

[Learn how to add a domain](https://autosend-pre-staging.up.railway.app/domain-configuration)
</Step>
...
[See authentication guide](https://autosend-pre-staging.up.railway.app/api-key)
</Step>
