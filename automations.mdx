...
description: 'Create contact-triggered email automations with three trigger types: added to list or segment, contact property matching, and contact property changes.'
