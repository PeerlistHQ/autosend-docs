...
<Steps>
  ...
  <Step title="Create the Corresponding Contact List or Segment">
    ...
    **Example:** For a Pro plan onboarding sequence, create a segment called "Pro Plan Members" that includes all contacts with the attribute `plan: pro`. When a user purchases a Pro plan and is added to this segment, the automation will trigger automatically.
  </Step>
