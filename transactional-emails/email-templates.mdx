...
icon: '/icons/email-templates.svg'
---
...
<Note>
  You can also create and manage templates from your AI assistant. Connect the <a href={APP_PATHS.aiMcpServer}>AutoSend MCP server</a> to create, update, and search templates using natural language. Install the <a href={APP_PATHS.aiSkills}>AutoSend skill</a> to give your AI coding agent the context it needs to generate template code in your editor.
</Note>

## Creating an Email Template in AutoSend

<Frame>
  <img src='/images/email-templates.png' alt="Create email template"  />
</Frame>
...
<CardGroup cols={2}>
  <Card icon='/icons/mcp-server.svg' href={APP_PATHS.aiMcpServer} title='MCP Server'>
    Create and manage templates from your AI assistant using the AutoSend MCP server.
  </Card>
  <Card icon='/icons/skill.svg' href={APP_PATHS.aiSkills} title='AutoSend Skill'>
