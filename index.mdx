...
<Columns cols={2}>
	...
	<Card title='SendGrid' icon='/icons/brand-sendgrid.png' href={APP_PATHS.migrationSendgrid} horizontal />
</Columns>
...
<Columns cols={2}>
	...
	<Card title='Contact Support' icon='/icons/support.svg' href={`mailto:${SUPPORT_EMAIL}`} horizontal />
</Columns>
