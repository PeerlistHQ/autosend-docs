...
<Columns cols={2}>
	<Card title='Send with API' icon='code' iconType='duotone' href={APP_PATHS.sendingEmail}>
		Learn how to send Transactional emails using the AutoSend email API.
	</Card>
	<Card title='Send with SMTP' icon='server' iconType='duotone' href={APP_PATHS.smtpIntroduction}>
...
<Columns cols={2}>
	...
	<Card title='Email Automations' icon='bolt' iconType='duotone' href={APP_PATHS.automations}>
	...
	<Card title='Domain Warmup' icon='fire' iconType='duotone' href={APP_PATHS.domainWarmup}>
...
<Card title='Brand Kit' icon='palette' iconType='duotone' href='/brand-kit' horizontal>
