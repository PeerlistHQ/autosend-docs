...
<Columns cols={2}>
	...
	<Card
		title='Sending emails with API'
		icon='send'
		iconType='duotone'
		href={APP_PATHS.sendingEmail}>
		Learn how to send Transactional emails using the AutoSend email API.
	</Card>
	<Card
		title='Send email with SMTP'
		icon='server'
		iconType='duotone'
		href={APP_PATHS.smtpIntroduction}>
...
<Card title="Brand Kit" icon="palette" iconType="duotone" href="/brand-kit" horizontal>
	Download official AutoSend logos, icons, and brand assets for your integrations and marketing materials.
</Card>
