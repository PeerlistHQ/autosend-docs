...
title: "API Keys"
description: "All API requests to AutoSend must be authenticated using an API key. This guide covers how to create API keys and authenticate your requests."
---
...
1. Log in to your <a href={{ type:"mdxJsxAttributeValueExpression",value:"AUTOSEND_PATHS.dashboard",data:{estree:{type:"Program",start:656,end:680,body:[{type:"ExpressionStatement",expression:{type:"MemberExpression",start:656,end:680,loc:{start:{line:19,column:27,offset:656},end:{line:19,column:51,offset:680}},object:{type:"Identifier",start:656,end:670,loc:{start:{line:19,column:27,offset:656},end:{line:19,column:41,offset:670}},name:"AUTOSEND_PATHS",range:[656,670]},property:{type:"Identifier",start:671,end:680,loc:{start:{line:19,column:42,offset:671},end:{line:19,column:51,offset:680}},name:"dashboard",range:[671,680]},computed:false,optional:false,range:[656,680]},start:656,end:680,loc:{start:{line:19,column:27,offset:656},end:{line:19,column:51,offset:680}},range:[656,680]}],sourceType:"module",comments:[],loc:{start:{line:19,column:27,offset:656},end:{line:19,column:51,offset:680}},range:[656,680]}} }} title="AutoSend dashboard">
   AutoSend dashboard</a>
...
<Note>
  ...
  <li>
  Copy the key immediately to your clipboard</li>
  ...
  <li>
  Download the .txt file as a backup</li>

   <li>
  Never commit API keys to version control (Git, SVN, etc.)</li>

   <li>
  Never share your API key publicly or in client-side code</li>
