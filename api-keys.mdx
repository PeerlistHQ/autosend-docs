...
<Steps>
  <Step title="Navigate to API Keys" titleSize='h3'>
    ...
    <Frame>
    	<img src="/images/api-keys/create-api-key-step-1.png" alt="API Keys dashboard showing list of API keys" />
    </Frame>
  </Step>
  <Step title="Generate a New API Key" titleSize='h3'>
    A modal will open where you:
    <Frame>
    	<img src="/images/api-keys/create-api-key-step-2.png" alt="API Keys dashboard showing list of API keys" />
    </Frame>
