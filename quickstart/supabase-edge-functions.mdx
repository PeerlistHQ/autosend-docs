...
import {AUTOSEND_BASE_URL,SUPABASE,SUPABASE_DOCS_CLI} from '/snippets/custom-variables.mdx'
...
- An <a href={AUTOSEND_BASE_URL} title='AutoSend'> AutoSend account</a> with an API key
- A <a href={SUPABASE} title='Supabase'>Supabase project</a>
- <a href={SUPABASE_DOCS_CLI} title='Supabase docs'>Supabase CLI</a> installed (v1.0 or later)
