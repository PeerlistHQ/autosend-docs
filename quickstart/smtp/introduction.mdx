...
<CardGroup cols={2}>
  <Card title="Verified Domain" icon="globe">
    Verify your sending domain in <a href={APP_PATHS.domainConfiguration}>Domain Settings</a>
  </Card>
</CardGroup>
...
<Note>
You can generate your API key secret in the <a href={AUTOSEND_PATHS.apiKey} target="_blank" rel="noopener noreferrer">API Keys settings</a>.
</Note>
