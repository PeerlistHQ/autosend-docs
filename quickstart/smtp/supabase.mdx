---
title: "Supabase SMTP Configuration"
...
Supabase uses email for authentication flows like sign-up confirmations, password resets, and magic links. By default, Supabase uses its built-in email provider, but you can configure it to use AutoSend SMTP for better deliverability and custom branding.
...
<Steps>
  <Step title="Get your AutoSend API key" titleSize="h3">
  ...
  <Step title="Enter SMTP Credentials" titleSize="h3">
    ...
    <Frame>
      <img src="/images/smtp/supabase-smtp-settings.png" alt="Supabase SMTP configuration screen" />
    </Frame>
  </Step>
...
<Card title="Edge Functions Integration" icon="bolt" iconType="duotone" href="/guides/supabase-edge-functions">
