...
<CardGroup cols={2}>
	<Card title='Auth0' href='/guides/auth0-custom-action' icon='/icons/brand-auth0.png'>
		Deliver Auth0 authentication emails through the AutoSend API using a Custom Email Provider
		Action.
	</Card>
	<Card title='Better Auth' href='/guides/better-auth' icon='/icons/brand-better-auth.png'>
		Send authentication emails for verification, password reset, and OTP with Better Auth.
	</Card>
	<Card title='Convex' href='/guides/convex' icon='/icons/brand-convex.png'>
		Use the official AutoSend Convex component for transactional emails with queueing, retries, and
		webhook.
	</Card>
	<Card title='QStash' href='/guides/QStash' icon='/icons/brand-qstash.png'>
		Use Upstash QStash to queue, schedule, retry, and reliably deliver emails through AutoSend.
	</Card>
	<Card title='Supabase' href='/guides/supabase-edge-functions' icon='/icons/brand-supabase.png'>
