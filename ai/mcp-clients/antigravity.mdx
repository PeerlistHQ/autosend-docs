...
icon: '/images/ai-tools/antigravity.png'
---
...
<CardGroup cols={2}>
	<Card title='MCP Server Overview' icon='/icons/mcp-server.svg' href={APP_PATHS.aiMcpServer}>
		See all available tools, guided workflows, and examples.
	</Card>
	<Card title='AutoSend Skills' icon='/icons/skill.svg' href={APP_PATHS.aiSkills}>
