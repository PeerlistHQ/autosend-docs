...
<CardGroup cols={2}>
	...
	<Card title='Verified Sender' href={APP_PATHS.sender}>
...
<CardGroup cols={2}>
	...
	<Card title='Copilot' icon='/images/ai-tools/copilot.png' href={APP_PATHS.mcpCopilot}>
		VS Code with GitHub Copilot
	</Card>
	<Card title='Windsurf' icon='/images/ai-tools/windsurf.png' href={APP_PATHS.mcpWindsurf}>
		Windsurf MCP configuration
	</Card>
	<Card title='Codex CLI' icon='/images/ai-tools/codex.png' href={APP_PATHS.mcpCodex}>
	...
	<Card title='Raycast' icon='/images/ai-tools/raycast.png' href={APP_PATHS.mcpRaycast}>
...
<CardGroup cols={2}>
	...
	<Card title='Campaigns' icon='bullhorn' href={APP_PATHS.campaigns}>
