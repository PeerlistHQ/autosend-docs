...
| Tool                 | Description                                           |
| -------------------- | ----------------------------------------------------- |
| `list_custom_fields` | List custom contact fields with their names and types |
...
- Before referencing a contact field in a filter, call `list_custom_fields` so you use the exact bare field name.
...
Learn more about <a href={APP_PATHS.automations}>Email Automations</a>, <a href={APP_PATHS.events}>Events</a>, and <a href={APP_PATHS.contactsCustomFields}>Custom Fields</a>.
