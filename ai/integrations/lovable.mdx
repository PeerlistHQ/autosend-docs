...
icon: '/images/ai-tools/lovable.png'
---
...
<Frame>
	<img src='/images/ai-tools/autosendxlovable.jpg' alt='Lovable' />
</Frame>
...
<CardGroup cols={2}>
	...
	<Card title='API Reference' icon='/icons/api.svg' href={APP_PATHS.apiReferenceIntroduction}>
		Full API documentation with all endpoints and parameters.
	</Card>
	<Card title='Variables' icon='/icons/variables.svg' href={APP_PATHS.templateVariables}>
