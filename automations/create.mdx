...
- **For property-based triggers:** Ensure your contacts have the relevant <a href={APP_PATHS.contactsContactProperties}>contact properties</a> set up. The automation will evaluate these properties to determine when to trigger.
