...
<CardGroup cols={2}>
	<Card title='Next.js Example (JavaScript)' icon='github' href='https://github.com/autosendhq/autosend-nextjs-example'>
		A Next.js example app in JavaScript using the AutoSend SDK.
	</Card>
	<Card title='Next.js Example (TypeScript)' icon='github' href='https://github.com/autosendhq/autosend-nextjs-ts-example'>
