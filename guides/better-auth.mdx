...
<Info>
	For general Better Auth setup and configuration, see the [Better Auth
	documentation](https://www.better-auth.com/docs). This guide focuses specifically on integrating
	AutoSend as your email provider.
</Info>
...
<Note>
	You must send emails from a verified domain to ensure deliverability.{' '}
	<a href={APP_PATHS.domainConfiguration}>Learn how to configure your domain</a>.
</Note>
...
<Columns cols={2}>
	<Card title='Email Templates' icon='file-code' iconType='duotone' href={APP_PATHS.emailTemplates}>
	...
	<Card title='Sending Domain' icon='globe' iconType='duotone' href={APP_PATHS.domainConfiguration}>
