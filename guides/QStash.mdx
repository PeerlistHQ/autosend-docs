...
<Frame>![AutoSend x Better Auth](/images/guides/qstash.jpg)</Frame>
...
export async function POST(req) {
  ...
  // body contains the AutoSend response, e.g.:
  // { success: true, data: { emailId: "em_xxx", message: "Email sent", totalRecipients: 1 } }
