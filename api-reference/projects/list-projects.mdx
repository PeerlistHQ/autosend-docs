...
<ResponseField name="data" type="object">
  ...
  <ResponseField name="data.projects" type="object[]">
    ...
    <ResponseField name="authenticatedSenders" type="object[]">
      List of authenticated email senders
    ...
    <ResponseField name="credentials" type="object[]">
      API key credentials (secrets are never returned)
