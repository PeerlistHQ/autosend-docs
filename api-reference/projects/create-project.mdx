...
<ResponseField name="data" type="object">
  ...
  <ResponseField name="data.authenticatedSenders" type="object[]">
    List of authenticated senders (empty for new projects)
  </ResponseField>
  ...
  <ResponseField name="data.credentials" type="object[]">
    API key credentials associated with the project
  </ResponseField>
