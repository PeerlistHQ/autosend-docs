...
<ParamField path="listIds" type="array">
  IDs of the contact lists to add this contact to. You can find list IDs in your <a href={AUTOSEND_PATHS.contactsPage} target='_blank' title='Automations'>AutoSend Dashboard</a>. 
...
<ParamField path="customFields" type="object" >
  ...
  Key-value pairs for custom contact attributes. There are four supported value types: `string`, `number`, `boolean`, and `date`. Learn more about <a href={APP_PATHS.customFieldAPIRef} target='_blank' title='Automations'>custom fields</a>.
