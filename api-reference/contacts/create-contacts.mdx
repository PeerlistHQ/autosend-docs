...
<ParamField path="listIds" type="array">
  IDs of contact lists - Separate from global contacts. Do not pass segment IDs. This will run Segmentation and Automations for the Global contact list and the passed contact list ids.
