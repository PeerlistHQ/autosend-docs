...
<ParamField path="contactProperties" type="object" >
  ...
  <ResponseField name="contactProperties.{key}" type="string" />
  </Expandable>
...
<ResponseField name="data" type="object">
  ...
  <ResponseField name="data.contactProperties" type="object">
