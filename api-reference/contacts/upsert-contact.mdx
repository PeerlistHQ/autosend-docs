...
<ParamField path="listIds" type="array">
  IDs of contact lists - Separate from global contacts. Do not pass segment IDs. This will run Segmentations and Automations for the newly passed contact list ids.
