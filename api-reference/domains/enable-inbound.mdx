...
next verification check, inbound emails becomes live
...
<ResponseField name="data" type="object">
  ...
  <Expandable title="Domain object">
    ...
    <ResponseField name="inboundDomainVerifiedAt" type="string">
      ISO 8601 timestamp of when the inbound MX record was detected i.e inbound is verified and live. `null` until the
