...
<ParamField path="email" type="string" required>
  Email address for the sender. The domain portion must match a verified SES domain on the project.
...
<ResponseField name="400 - Domain not verified" type="object">
  Returned when the sender's email domain does not match any verified SES domain on the project.
