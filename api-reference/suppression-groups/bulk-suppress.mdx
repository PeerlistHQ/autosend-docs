...
description: 'Add multiple email addresses to a suppression group in bulk using the AutoSend API.'
...
<span className='text-sm'>Emails suppressed successfully</span>
...
<ResponseField name="data" type="object">
  <Expandable title="child attributes">
    <ResponseField name="data.suppressed" type="integer">
