...
<ResponseField name="data" type="object">
  ...
  <ResponseField name="data.providerMessageId" type="string">
  ...
  <ResponseField name="data.attachments" type="object[]">
    Attachment metadata. Each entry includes `filename`, `contentType`, `size`, `contentId`, `isInline`, `partIndex`, and a zero-based `index` used to download the attachment.
  </ResponseField>
  ...
  <ResponseField name="data.spamVerdict" type="string">
    SES spam verdict (e.g. `PASS`, `FAIL`)
  </ResponseField>
