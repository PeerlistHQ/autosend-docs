    ...
    "items": [
      {
        ...
        "snippet": "Hi, I wanted to check on the status of order #4821…",
        "status": "PROCESSED",
        ...
        "createdAt": "2026-06-20T10:15:31.000Z"
      }
    ],
    "pagination": {
      "page": 1,
...
<ResponseField name="data" type="object">
  ...
  <ResponseField name="data.items" type="object[]">
    ...
    <ResponseField name="providerMessageId" type="string">
    ...
    <ResponseField name="inReplyToEmailActivityId" type="string | null">
      ID of the outbound email this message is a reply to, if matched
    </ResponseField>

    <ResponseField name="attachments" type="object[]">
      Attachment metadata (`filename`, `contentType`, `size`, `contentId`, `isInline`, `partIndex`)
    </ResponseField>
