...
description: 'Permanently delete a campaign by ID using the AutoSend API.'
...
<ResponseField name="400 - Cannot delete non-draft campaign" type="object">
...
<ResponseField name="404 - Campaign not found" type="object">
