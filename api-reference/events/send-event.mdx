...
<ParamField path="email" type="string">
  Email of the contact this event belongs to. Either `email` or `contactId` must be provided.

  Example: `"jane@example.com"`
</ParamField>

<ParamField path="contactId" type="string">
  MongoDB ObjectId of the contact. Either `email` or `contactId` must be provided.
