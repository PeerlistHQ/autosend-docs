...
<Frame>![Autosend Suppressions Screenshot](/images/autosend-suppressions-screenshot.png)</Frame>

You can access all suppression records from the <a href={AUTOSEND_PATHS.globalSuppressions} target="_blank">Suppressions ↗</a> tab in the side-panel. Each record includes:
