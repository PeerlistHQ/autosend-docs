...
<Steps>
<Step title="Navigate to Webhooks in your AutoSend dashboard" titleSize='h3' />
<Step title="Click on the webhook" titleSize='h3' />
<Step title="Click Reveal Secret" titleSize='h3' />
<Step title="Copy the secret and store it securely" titleSize='h3' />
</Steps>
