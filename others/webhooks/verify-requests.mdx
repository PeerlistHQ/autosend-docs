...
<Steps>
  <Step
    title='Extract the signature from the X-Webhook-Signature header'
    titleSize='h3'
  />
  <Step
    title='Get the raw request body as a string (before parsing)'
    titleSize='h3'
  />
  <Step
    title='Compute the expected signature using your webhook secret'
    titleSize='h3'
  />
  <Step
    title='Compare signatures using a constant-time comparison function'
    titleSize='h3'
  />
</Steps>
...
<Steps>
  ...
  <Step
    title='Copy the secret and store it securely in your environment variables'
    titleSize='h3'
  />
</Steps>
...
<Steps>
  <Step
    title='Create a new webhook with the same events and URL'
    titleSize='p'
  />
  <Step
    title='Update your application to support both old and new secrets temporarily'
    titleSize='p'
  />
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href={APP_PATHS.webhookBestPractices}
  >
