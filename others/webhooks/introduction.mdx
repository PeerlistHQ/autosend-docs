...
- **Receive incoming emails in your app** with the `email.received` event and the <a href={APP_PATHS.inboundIntroduction}>Inbound Email API</a>
...
<Columns cols={2}>
  <Card title="Event Types" icon="/icons/event-types.svg" href={APP_PATHS.webhookEventType}>
    Complete list of webhook events and payloads
  </Card>

  <Card title="Retries and Replays" icon="/icons/retries-refresh.svg" href={APP_PATHS.webhookRetries}>
    Automatic retry logic and best practices
  </Card>

  <Card title="Verify Webhook Requests" icon="/icons/verify-requests.svg" href={APP_PATHS.webhookVerifyRequests}>
  ...
  <Card title="Inbound Email API" icon="/icons/inbound.svg" href={APP_PATHS.inboundIntroduction}>
