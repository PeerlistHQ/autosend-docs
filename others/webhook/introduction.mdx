...
<Columns cols={2}>
  <Card title="Event Types" icon="question" iconType="duotone">
   Complete list of webhook events and payloads
  </Card>
  <Card title="Retries and Replays" icon="star-of-life" iconType="duotone" >
    Automatic retry logic and best practices
  </Card>
  <Card title="Verify Webhook Requests" icon="star-of-life" iconType="duotone" >
