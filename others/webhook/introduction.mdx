...
1. Navigate to the **Webhooks** section in your AutoSend dashboard
...
1. **For Email Events**: Send a test campaign or transactional email through the AutoSend dashboard
...
Yes! Use tools like [ngrok](https://ngrok.com) or [localtunnel](https://localtunnel.github.io) to expose your local server to the internet, then create a webhook in the dashboard with your ngrok URL. Trigger events by sending emails or managing contacts in AutoSend, and your local endpoint will receive the webhooks.
</Accordion>
