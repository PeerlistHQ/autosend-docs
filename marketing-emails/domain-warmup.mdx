---
title: 'Domain Warmup with AutoSend'
...
icon: '/icons/domain-warmup.svg'
---

<Frame>
	<img
		src='/images/domain-warmup.jpg'
		alt='Bar chart showing the daily email sending schedule during domain warmup with projected volume per day'
	/>
</Frame>
...
<Frame>
	<img
		...
		alt='Campaign details page with When to send section showing Now, Schedule, and Gradual Send options'
	/>
</Frame>
...
<Frame>
	<img
		...
		alt='Date and time picker for scheduling the Gradual Send start date'
	/>
</Frame>
