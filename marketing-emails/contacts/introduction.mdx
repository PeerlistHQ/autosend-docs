...
<a href={APP_PATHS.contactsContactProperties} title='Contact properties'>
	Contact properties
</a>
...
<Columns cols={2}>
	<Card title='Tally Forms' icon='/icons/brand-tally.png' href='/others/integrations/tally-forms'>
