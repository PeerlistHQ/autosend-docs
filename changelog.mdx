...
<Frame>![Tally Forms integration](/images/changelog/changelog-tally-integration.jpg)</Frame>
...
<Frame>![Official Convex component](/images/changelog/inbound-email-api.jpg)</Frame>
...
1. Automations got more flexible: branch steps now support a wait/delay, so different paths can pause before continuing.
2. For gradual send, you can now change the send time even while a campaign is paused.
3. New sending domains now warm up on their own. AutoSend automatically raises your daily send limit a little each day to build a healthy reputation, with a clear banner showing your current limit. Read the <a href={APP_PATHS.domainWarmup}>domain warmup guide</a> for details.
4. The email builder gained margin controls for finer spacing.
5. Contacts can now store a mobile number as a default field.
6. Attachments and webhook events now carry stable, consistent identifiers with better validation, making it easier to reliably match events and files in your own systems.
7. Error messages across the API (campaigns, webhooks, events, projects, suppression groups, and more) were rewritten to be clearer and more helpful.
...
<Frame>![Official Convex component](/images/changelog/autosend-convex-component.jpg)</Frame>
...
<Frame>
	![Event-triggered automations and EU region](/images/changelog/event-triggered-automation.png)
</Frame>
...
<Frame>![RBAC and Projects API](/images/changelog/automation-branching.jpeg)</Frame>
